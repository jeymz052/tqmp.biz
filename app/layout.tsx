...
export const metadata: Metadata = {
  ...
  description:
    "Your Integrated Network of Glass and Aluminum Solutions. TQMP Philippines offers bullet proofing, glass manufacturing, aluminum manufacturing, glass processing, and more.",
};
